    ...
    <div className={styles.page}>
      <div className="container">
        <header className={styles.header}>
          ...
          <p className={styles.description}>Driver ranking based on K-Means clustering algorithm</p>
        </header>
        ...
        {!loading && !error && data && (
          <div className={styles.tiers}>
            {Object.entries(data.tiers).map(([tierName, tier]) => (
              <TierCard key={tierName} name={tierName} tier={tier} onDriverClick={handleDriverClick} />
            ))}
          </div>
        )}
      </div>
