  ...
  return (
    <div className={styles.filters}>
      ...
      <div className={styles.row}>
        <Select label="Number of Tiers" value={nTiers} options={TIER_OPTIONS} onChange={onNTiersChange} />
        <Select label="Minimum Races" value={minRaces} options={MIN_RACES_OPTIONS} onChange={onMinRacesChange} />
      </div>
    </div>
  );
};
